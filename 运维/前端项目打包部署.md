...
3. 配置nginx
找到nginx文件：
![找到nginx文件](https://cdn.nlark.com/yuque/0/2025/png/2488285/1756164364970-6cd17c90-a80d-4efc-9760-c9047684a51b.png?x-oss-process=image%2Fformat%2Cwebp)
编辑后的nginx文件如下：主要是配置静态文件的目录和访问的端口号：如下,目录：/www/wwwroot/order_takeout-turntable 端口号：8090
```nginx
